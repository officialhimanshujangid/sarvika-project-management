      ...
      <div className="bg-[var(--bg-secondary)] !rounded-xl !p-6 w-full max-w-2xl shadow-2xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-start !gap-6 !p-6 bg-[var(--bg-tertiary)] !rounded-lg">
            <div className="w-20 h-20 bg-[var(--accent-primary)] !rounded-full flex items-center justify-center text-white font-bold text-2xl">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center !gap-2 !mb-2">
                <span className="inline-block !px-3 !py-1 text-sm bg-[var(--accent-primary)]/10 text-[var(--accent-primary)] rounded-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 !gap-6">
            <div className="!space-y-4">
              <h4 className="text-lg font-semibold text-[var(--text-primary)] border-b border-[var(--border-color)] !pb-2">
                Contact Information
              </h4>
            ...
            <div className="!space-y-4">
              ...
              {team ? (
                <div className="flex items-center !gap-3">
                  ...
                  <div>
                    <p className="text-sm text-[var(--text-secondary)]">Assigned Team</p>
                ...
                <div className="flex items-center !gap-3">
                  <FiUsers className="text-[var(--text-secondary)]" size={20} />
                  <div>
                    <p className="text-sm text-[var(--text-secondary)]">Team Assignment</p>
